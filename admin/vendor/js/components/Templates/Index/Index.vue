    ...
    <loading :loading="!loaded">
        ...
        <template v-if="loaded">
            <div class="flex mb-5" :class="resources.seachable ? 'justify-between' : 'justify-end'">
                ...
                <template v-else>
                    <router-link :to="createLink" v-if="resources.can.create" class="es:w-1/2 es:flex es:justify-end">
                        <a-button>
                            {{ __('Create') }}
                        </a-button>
                    </router-link>
        ...
        computed: {
            ...
            showActions() {
                ...
                return Object.keys(this.resources.can).filter(ability =>
                    ['view', 'update', 'delete'].includes(ability)
                    && this.resources.can[ability]
                ).length > 0
            },
            loaded() {
