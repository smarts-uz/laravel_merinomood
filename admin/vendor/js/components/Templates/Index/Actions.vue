<template>
    <td class="text-sm text-gray-600 p-0 text-left border-b w-28 pr-4 actions-cell">
        <div class="flex justify-around">
            <router-link :to="detailLink" class="inline-flex" v-if="resource.can.view">
                <i class="dripicons-preview"></i>
            </router-link>
            <router-link :to="updateLink" class="inline-flex" v-if="resource.can.update">
                <i class="dripicons-pencil"></i>
            </router-link>
            <button class="inline-flex" @click="remove" v-if="resource.can.delete">
