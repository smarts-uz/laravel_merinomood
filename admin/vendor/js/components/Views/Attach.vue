...
<script>
    ...
    export default {
            ...
            async createRequest() {
                ...
                try {
                    ...
                    if (!response.data.toast) {
                        this.$toast('success', 'Ресурс успешно создан!')
                    }
                } catch (error) {
        ...
        async created() {
            const {resource, id, relationship} = this.$route.params
            const viaRelationship = this.$route.query.viaRelationship
            this.route = `resources/${resource}/${id}/attach/${relationship}?viaRelationship=${viaRelationship}`
